    ...
    <div className="page-container bag-details">
      <div className="container-fluid">
        <div className="mt-50px mb-50px">
          <div className="text-uppercase size-14 color-nero d-flex">
            <span className="mr-2 bag-title">HOME</span>-
            <span className="mr-2 ml-2 bag-title">BAGS</span>-
            <span className="mr-2 ml-2 bag-title">ANCOTEMEE DELA</span>-
            <span className="color-dim-gray ml-2 bag-title">
        ...
        <div className="d-flex row">
          <PerfectScrollbar className="col-md-6 col-lg-5 review-img">
            {bag.img_reviews.map((img, index) => (
              <div
                key={index}
                className="text-center review-img-item"
                onClick={() => openReviewImg(img)}
              >
                <img src={img} alt="" />
              </div>
            ))}
          ...
          <div className="col-12 col-md-6 col-7 d-flex flex-column align-items-center align-items-md-end">
            <div className="right-col">
              <div className="mt-50px mt-md-0">
                <h3 className="size-31 font-title font-weight-bold text-center">
                  {bag.title}
                </h3>
                <div className="text-center mt-30px">
                  <span className="size-18 font-weight-semi">{bag.cost}</span>
                  <del className="size-14 ml-3 color-dim-gray bag-title">
                    {bag.originalCost}
                  </del>
                </div>
                <p className="size-16 color-dim-gray text-center mt-30px">
                  {bag.des}
                </p>
                <div className="d-flex flex-column align-items-center mt-40px choose-style">
                  <div>
                    <div className="d-flex align-items-center">
                      <div className="size-16 text-uppercase color-dim-gray label">
                        color
                      </div>
                  ...
                  <div className="d-flex flex-wrap mt-60px justify-content-center w-100">
                    ...
                    >
                      <span className="text-white size-14 ml-10px">
                        ADD TO CART
                      </span>
                    </Button>
                  </div>
      ...
      <div className="details mt-80px">
        ...
        <div className="d-flex mt-60px">
          <div
            className="size-18 font-weight-bold cursor-pointer"
            onClick={showReviews}
          >
      ...
      <div className="banner-session d-flex align-items-center mt-120px">
        <div className="container-fluid row">
          ...
          <div className="col-12 col-md-6 h-100">
            <h3 className="size-48 font-weight-bold font-title">
      ...
      <div className="container-fluid">
        <h4 className="size-16 color-dim-gray text-center text-uppercase mt-120px">
          RELATED PRODUCTS
        </h4>
